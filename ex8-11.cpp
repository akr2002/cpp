...
void show_data(const int data[], std::size_t count = 1, std::string_view title = "Data Values", std::size_t width = 10, std::size_t perline = 5);
...
void show_data(const int data[], std::size_t count, std::string_view title, std::size_t width, std::size_t perline)
{
	...
	{
		std::cout << std::setw(width) << data[i];	// Dispaly a data item
