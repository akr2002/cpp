// Problems of implicit object converisons
...
int main()
{
	...
	else std::cout << "Volume of box1 is less than or equal to that of box2." << std::endl;
	...
	else std::cout << "Volume of box1 is less than or equal to 50" << std::endl;
