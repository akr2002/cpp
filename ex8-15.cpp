...
// int largest(const std::vector<std::string> &words);	/* would not compile: overloaded functions must differ in more than just their return type! */
