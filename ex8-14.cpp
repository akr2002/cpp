...
std::optional<std::size_t> find_last(std::string_view string, char to_find, std::optional<std::size_t> start_index = std::nullopt);
...
std::optional<std::size_t> find_last(std::string_view string, char to_find, std::optional<std::size_t> start_index)
{
